    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      <div class="xl:grid xl:grid-cols-2 xl:gap-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 w-full">
          <div>
            <p class="font-semibold text-amber-800">Visit Us</p>
          ...
          <div>
            <p class="font-semibold text-amber-800">Hours</p>
            <div class="mt-4 space-y-1">
              <p class="text-gray-600">Mon-Fri: 7am - 7pm</p>
              <p class="text-gray-600">Sat-Sun: 8am - 5pm</p>
            </div>
          </div>
          <div>
            <p class="font-semibold text-amber-800">Contact</p>
            <div class="mt-4 space-y-1">
          ...
          <div>
            <p class="font-semibold text-amber-800">Account</p>
...
const handleLogout = async () => {
  try {
    ...
    toast.add('You have been signed out')
    router.push('/')
  } catch (error) {
