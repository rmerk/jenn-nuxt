    ...
    <section>
        ...
        <div class="px-6 lg:px-12">
            <nav class="flex justify-between">
                <div class="flex w-full items-center py-6">
                    <a href="#">
                        <img class="h-12" src="uinel-assets/logos/ecommerce/uistore-gray-black.svg" alt="">
                    </a>
                    <ul class="hidden xl:flex px-4 ml-20 2xl:ml-40 mr-auto">
                        <li class="mr-16">
                            <a class="font-medium hover:text-darkBlueGray-400" href="#">Stories</a>
                        </li>
                        <li class="relative mr-16">
                            <a class="flex items-center font-medium hover:text-darkBlueGray-400" href="#">
                            ...
                            <div class="product-menu hidden absolute top-0 left-0 mt-24 -ml-64 pl-24 pr-16 pt-16 pb-24 bg-white rounded-lg z-50">
                                <div class="absolute top-0 left-0 ml-72 w-7 h-7 bg-white transform rotate-45 -translate-y-1/2" />
                                <div class="flex flex-wrap min-w-max -mx-4 lg:-mx-10">
                                    <div class="w-full md:w-1/2 lg:w-1/4 px-4 lg:px-10">
                                        <div>
                                            <h3 class="mb-4 text-xl font-heading font-medium">
                                                Smartphone
                                            </h3>
                                            <ul class="w-full">
                                                <li class="mb-4">
                                                    <a class="text-gray-400 hover:text-gray-500" href="#">View all</a>
                                                </li>
                                                <li class="mb-4">
                                                    <a class="text-gray-400 hover:text-gray-500" href="#">Premium&nbsp;Phones</a>
                                                </li>
                                                <li class="mb-4">
                                                    <a class="text-gray-400 hover:text-gray-500" href="#">Basic</a>
                                                </li>
                                                <li><a class="text-gray-400 hover:text-gray-500" href="#">Sale</a></li>
                                            </ul>
                                        </div>
                                        <div class="w-40 mt-5 mb-7 border-b border-gray-100" />
                                        <div class="w-full">
                                            <h3 class="mb-4 text-xl font-heading font-medium">
                                                Tablet
                                            </h3>
                                            <ul class="w-full">
                                                ...
                                                <li class="mb-4">
                                                    <a class="text-gray-400 hover:text-gray-500" href="#">Premium&nbsp;Tablets</a>
                                                </li>
                                                <li class="mb-4">
                                                    <a class="text-gray-400 hover:text-gray-500" href="#">For&nbsp;Designers</a>
                                                </li>
                                                <li><a class="text-gray-400 hover:text-gray-500" href="#">Sale</a></li>
                                            </ul>
                                        </div>
                                        <div class="w-40 mt-5 border-b border-gray-100" />
                                    </div>
                                    <div class="w-full md:w-1/2 lg:w-1/4 px-4 lg:px-10">
                                        <h3 class="mb-4 text-xl font-heading font-medium">
                                            Brand
                                        ...
                                        <ul>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Apple iPhone</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Blackberry</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Google</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Huawei</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Nokia</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Oppo</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Samsung</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Sony</a>
                                            </li>
                                            <li><a class="text-gray-400 hover:text-gray-500" href="#">Xiaomi</a></li>
                                        </ul>
                                        <div class="w-40 mt-5 mb-7 border-b border-gray-100" />
                                        <h3 class="mb-4 text-xl font-heading font-medium">
                                            System
                                        ...
                                        <ul>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">iOS</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Android</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">View all</a>
                                            </li>
                                    ...
                                    <div class="w-full md:w-1/2 lg:w-1/4 px-4 lg:px-10">
                                        ...
                                        <ul>
                                            ...
                                            <li><a class="text-gray-400 hover:text-gray-500" href="#">Watches</a></li>
                                        </ul>
                                        <div class="w-40 mt-5 mb-7 border-b border-gray-100" />
                                        <h3 class="mb-4 text-xl font-heading font-medium">
                                            Computers
                                        ...
                                        <ul>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Apple iMac</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Memory</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">PC</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Graphic Cards</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Monitors</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Hard Disk Drivers</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Cables</a>
                                            </li>
                                            <li class="mb-4">
                                                <a class="text-gray-400 hover:text-gray-500" href="#">Keyboards</a>
                                            </li>
                                            <li><a class="text-gray-400 hover:text-gray-500" href="#">Printers</a></li>
                                        </ul>
                                        <div class="w-40 mt-5 border-b border-gray-100" />
                                    </div>
                                    <div class="w-full md:w-1/2 lg:w-1/4 px-4 lg:px-10">
                                        <div class="relative flex items-end h-96 w-full rounded-lg bg-cover bg-no-repeat" style="background-image: url('uinel-assets/images/ecommerce-navigations/placehodler-right-banner.png');">
                                            <div class="mx-2 mb-5 px-2 py-4 bg-white rounded-lg">
                                                <h4 class="text-xl font-heading font-medium leading-tight">
                                                    Connected home
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="w-40 my-8 border-b border-gray-100" />
                        ...
                        <li><a class="font-medium hover:text-darkBlueGray-400" href="#">Outlet</a></li>
                    </ul>
                    <div class="relative hidden xl:block">
                        <img class="absolute top-1/2 transform -translate-y-2/4 pl-6 mt-px" src="uinel-assets/elements/navigations/search-gray-icon.svg" alt="">
                    ...
                    <div class="hidden xl:flex items-center">
                        ...
                        <a class="flex items-center text-darkBlueGray-400 hover:text-darkBlueGray-500" href="#">
                            ...
                            <img class="ml-5" src="uinel-assets/elements/navigations/avatar-online.png" alt="">
        ...
        <div class="pb-10">
            <div class="relative bg-blueGray-100 rounded-b-10xl overflow-hidden">
                <img class="hidden lg:block absolute top-0 right-0 w-1/2 h-full py-20" src="uinel-assets/images/ecommerce-headers/placeholder-laptop.png" alt="">
                <div class="container px-4 mx-auto">
                    <div class="relative flex flex-wrap -mx-4 py-24 xl:pt-36 xl:pb-20">
                        <div class="w-full lg:w-auto max-w-max px-4">
                            ...
                            <img class="lg:hidden" src="uinel-assets/images/ecommerce-headers/placeholder-laptop.png" alt="">
                            <div class="relative max-w-max mx-auto md:mx-0">
                                <div class="relative flex flex-wrap justify-between bg-white rounded-5xl overflow-hidden z-10">
                                    ...
                                    <div class="w-full md:w-1/4">
                                        <img class="w-full h-28 md:h-auto object-cover" src="uinel-assets/images/ecommerce-headers/women-placeholder.png" alt="">
                                    </div>
                                </div>
