...
import type { Order } from '@/types/collections';
...
const { data: orders } = await useAsyncData('orders', () => find<Order>('orders', {
    filters: {
                        ...
                        >
                            ...
                            <div class="mt-4">
                                <div class="text-sm text-gray-500">
                                    <div
                                        v-for="customer in order.customerInformation"
                                        :key="customer.id" class="flex justify-between"
                                    >
