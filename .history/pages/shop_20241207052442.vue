...
const categories = computed(() => {
    if (!products.value)
        return ['All'];
    const uniqueCategories = new Set(products.value.data.map(product => product.categories));
...
const filteredProducts = computed(() => {
    ...
    return products.value.data.filter(product => product.category === selectedCategory.value);
});
</script>
