...
import type { type Strapi5ResponseMany, Strapi5ResponseSingle } from '@nuxtjs/strapi';
...
const { data: orders } = await useAsyncData<Strapi5ResponseSingle>('orders', () => find<Order>('orders', {
    filters: {
