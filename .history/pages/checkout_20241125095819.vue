...
onMounted(async () => {
  ...
  const payments = await window.Square.payments(process.env.SQUARE_APP_ID, process.env.SQUARE_LOCATION_ID)
  card = await payments.card()
  await card.attach(cardContainer.value)
  isSquareInitialized.value = true
})
