  ...
  <div class="bg-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        <div v-for="article in articles.data" :key="article.id" class="flex flex-col overflow-hidden rounded-lg shadow-lg">
          ...
          <div class="flex flex-1 flex-col justify-between bg-white p-6">
            <div class="flex-1">
              ...
              <NuxtLink :to="'/blog/' + article.id" class="mt-2 block">
            ...
            <div class="mt-6 flex items-center">
              <div class="flex-shrink-0">
                ...
                <img class="h-10 w-10 rounded-full" :src="article.authorImage" :alt="article.author">
              </div>
              <div class="ml-3">
...
const { data: articles } = await useAsyncData('articles',
  () => find('articles', {
    fields: 'title,excerpt,author,authorImage,date,category,image',
