  ...
  <div class="bg-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        <h1 class="text-3xl font-extrabold text-amber-800">Our Products</h1>
        <p class="mt-4 text-xl text-gray-600">Fresh baked goods made with love</p>
      </div>

      <div class="mt-12">
        <!-- Category Filters -->
        <div class="flex justify-center space-x-4 mb-12 flex-wrap gap-y-2">
          <CategoryFilter
      ...
      <div class="mt-16 bg-amber-50 rounded-2xl p-8 text-center">
        <h2 class="text-2xl font-bold text-amber-800">Need a Custom Order?</h2>
...
const categories = computed(() => {
  ...
  const uniqueCategories = new Set(products.value.map(product => product.category?.name))
