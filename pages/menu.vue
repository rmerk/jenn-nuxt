  ...
  <div class="bg-white py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        <h1 class="text-3xl font-extrabold text-amber-800">Our Menu</h1>
        <p class="mt-4 text-xl text-gray-600">Fresh baked goods made daily</p>
      </div>

      <div class="mt-12">
        <div v-for="category in categories" :key="category.id" class="mb-12">
          <h2 class="text-2xl font-bold text-amber-700 mb-6">{{ category.name }}</h2>
